<x-app-layout variant="admin" page-title="Chỉnh sửa gói dịch vụ">
    <div class="max-w-[1000px] mx-auto space-y-8" x-data="{
        isUnlimitedClasses: true,
        isUnlimitedStudents: true,
        priceType: 'contact',
        hasApi: true,
        hasGps: true,
        hasReports: true,
        ...
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        <svg class="w-5 h-5 text-slate-400 dark:text-slate-500" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                        <span class="ml-1 text-sm font-medium text-slate-500 dark:text-slate-400 md:ml-2">Chỉnh sửa</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
                <h1 class="text-[28px] font-bold text-slate-900 dark:text-white mb-1">Chỉnh sửa gói dịch vụ</h1>
                <p class="text-slate-500 dark:text-slate-400 text-sm">Cập nhật thông số và các quyền lợi cho Gói Chuyên Nghiệp (Pro).</p>
            </div>
            <div class="flex gap-3">
                <a href="{{ route('admin.packages.show-mock') }}" class="px-5 py-2.5 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-600 text-slate-700 dark:text-slate-300 rounded-xl text-sm font-semibold hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors shadow-sm">
                    Hủy bỏ
                </a>
                <button class="px-6 py-2.5 bg-gradient-to-r from-amber-500 to-amber-600 text-white rounded-xl text-sm font-semibold hover:from-amber-600 hover:to-amber-700 shadow-sm shadow-amber-500/30 transition-all flex items-center gap-2">
        ...
        <form action="#" method="POST" class="space-y-6">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" value="Gói Chuyên Nghiệp (Pro)" class="w-full px-4 py-2.5 bg-transparent border border-slate-300 dark:border-slate-600 text-slate-900 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                    </div>
                    <div class="md:col-span-2">
                        <label class="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-2">Mô tả ngắn</label>
                        <input type="text" value="Giải pháp toàn diện không giới hạn dành cho các tổ chức" class="w-full px-4 py-2.5 bg-transparent border border-slate-300 dark:border-slate-600 text-slate-900 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                    </div>
                    
                    <div class="md:col-span-2">
                        <label class="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-2">Mô tả chi tiết</label>
                        <textarea rows="4" class="w-full px-4 py-3 bg-transparent border border-slate-300 dark:border-slate-600 text-slate-900 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">Giải pháp toàn diện không giới hạn dành cho các tổ chức, trung tâm đào tạo và trường học có quy mô lớn. Hỗ trợ đầy đủ các tính năng báo cáo chuyên sâu và tích hợp API hệ thống.</textarea>
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="md:col-span-2 bg-slate-50 dark:bg-slate-900/50 p-5 rounded-xl border border-slate-100 dark:border-slate-700 relative flex flex-col md:flex-row md:items-center justify-between gap-4">
                        ...
                        <div class="flex items-center gap-2">
                            <input type="number" value="100" class="w-24 px-4 py-2 bg-transparent border border-slate-300 dark:border-slate-600 text-slate-900 dark:text-white rounded-lg text-center font-bold focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            ...
            <div class="flex justify-end pt-4 pb-12">
                <button type="button" class="px-8 py-3 bg-gradient-to-r from-amber-500 to-amber-600 text-white rounded-xl text-base font-bold hover:from-amber-600 hover:to-amber-700 shadow-md shadow-amber-500/40 transition-all flex items-center gap-2 transform hover:-translate-y-0.5">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                    Lưu thay đổi
                </button>
            </div>
