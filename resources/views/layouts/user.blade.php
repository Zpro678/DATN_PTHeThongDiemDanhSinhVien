        ...
        <div x-data="{ showFabMenu: false }" class="relative flex h-screen overflow-hidden bg-background text-on-surface">
            ...
            <main class="flex h-full min-w-0 flex-1 flex-col overflow-hidden">
                ...
                @auth
                    ...
                    @endphp
                    @if($ongoingSession)
                        <div class="z-30 border-b border-blue-200 bg-gradient-to-r from-blue-50 via-blue-50 to-indigo-50 px-5 py-2.5 sm:px-8">
                            <div class="mx-auto flex max-w-[1300px] items-center justify-between gap-3">
