...
<head>
    ...
    <title>@yield('title', 'EduCheck Admin')</title>
    <meta name="description" content="Hệ thống quản lý điểm danh thông minh EduCheck">
...
<div class="app-wrapper">
    ...
    <aside class="sidebar">
        <div class="sidebar-brand">
            ...
            <div>
                <h1>EduCheck Admin</h1>
                <p>Premium Plan</p>
            </div>
        </div>

        <div style="padding: 0 16px 16px;">
            <a href="{{ route('sessions.create') }}" class="sidebar-new-btn">
        ...
        <div class="sidebar-footer">
            ...
            <form action="{{ route('logout') }}" method="POST">
                @csrf
                <button type="submit" class="sidebar-footer-btn danger" style="width:100%;">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.75" stroke="currentColor" style="width:20px;height:20px;"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 9V5.25A2.25 2.25 0 0 1 10.5 3h6a2.25 2.25 0 0 1 2.25 2.25v13.5A2.25 2.25 0 0 1 16.5 21h-6a2.25 2.25 0 0 1-2.25-2.25V15M12 9l3 3m0 0-3 3m3-3H2.25"/></svg>
                    Logout
                </button>
            </form>
        </div>
    ...
    <div class="main-content">
        ...
        <header class="topbar">
            <div class="topbar-search">
                <span class="font-bold text-primary" style="display:none;" id="mobile-brand">EduCheck</span>
            ...
            <div class="topbar-actions">
                <a href="{{ route('upgrade') }}" class="upgrade-btn" style="display:none;" id="upgrade-btn-desktop">Upgrade Pro</a>
    ...
    <nav class="mobile-nav">
        <a href="{{ route('student-checkin') }}" class="mobile-nav-link">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.75" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.26 10.147a60.438 60.438 0 0 0-.491 6.347A48.62 48.62 0 0 1 12 20.904a48.62 48.62 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.636 50.636 0 0 0-2.658-.813A59.906 59.906 0 0 1 12 3.493a59.903 59.903 0 0 1 10.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.717 50.717 0 0 1 12 13.489a50.702 50.702 0 0 1 3.741-1.342M12 20.904v-7.415"/></svg>
            <span>Check-in</span>
        </a>
        <a href="{{ route('history') }}" class="mobile-nav-link">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.75" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/></svg>
            <span>History</span>
        </a>
    </nav>
...
<script>
// Show upgrade btn on desktop, brand on mobile
function updateResponsive() {
    const isDesktop = window.innerWidth >= 769;
    const upgradeBtn = document.getElementById('upgrade-btn-desktop');
    const brand = document.getElementById('mobile-brand');
    if (upgradeBtn) upgradeBtn.style.display = isDesktop ? 'inline-flex' : 'none';
    if (brand) brand.style.display = isDesktop ? 'none' : 'block';
}
updateResponsive();
