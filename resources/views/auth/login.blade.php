    ...
    <div class="h-screen flex">
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 bg-white">
            <div class="w-full max-w-md">
                ...
                <div class="mb-5 rounded-xl border border-blue-100 bg-blue-50 p-4 text-sm text-blue-900">
                    <p class="font-bold">Tài khoản test</p>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    <button type="button" class="w-full flex items-center justify-center gap-3 bg-white border-2 border-slate-200 hover:border-slate-300 hover:bg-slate-50 active:bg-slate-100 text-slate-700 font-bold text-base px-4 py-4 rounded-xl transition-all shadow-sm cursor-pointer">
