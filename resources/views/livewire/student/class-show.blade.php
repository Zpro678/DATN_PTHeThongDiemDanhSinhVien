<div class="mx-auto max-w-7xl p-4 pb-24 sm:p-6 lg:p-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
    ...
    <div class="flex flex-col gap-6 lg:flex-row items-stretch">
        ...
        <div class="flex flex-col gap-6 lg:w-1/3 xl:w-1/4">
            <div class="flex h-full flex-col rounded-2xl bg-white p-6 shadow-sm ring-1 ring-outline-variant/20">
        ...
        <div class="flex flex-1 flex-col gap-6">
            <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-outline-variant/20">
    ...
    <div class="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-2">
        ...
        {{-- Lịch sử --}}
        <a href="{{ route('student.attendance.history', ['ma_user' => auth()->id(), 'classFilter' => $class->id]) }}" class="group flex flex-col items-center justify-center gap-3 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-outline-variant/20 transition-all hover:-translate-y-1 hover:shadow-lg hover:ring-primary/20">
        ...
        {{-- Đơn xin nghỉ --}}
        <a href="{{ route('student.leave-requests.create', ['ma_user' => auth()->id()]) }}" class="group flex flex-col items-center justify-center gap-3 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-outline-variant/20 transition-all hover:-translate-y-1 hover:shadow-lg hover:ring-[#F59E0B]/20">
