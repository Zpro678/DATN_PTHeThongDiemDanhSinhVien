<div class="w-full space-y-6 px-6 py-6 sm:px-10 lg:px-16 animate-in fade-in slide-in-from-bottom-4 duration-500">
    ...
    <div class="mb-4">
        <h1 class="text-xl font-extrabold leading-tight tracking-tight text-slate-800 sm:text-2xl">Thêm lớp học mới</h1>
    </div>
            ...
            <div class="space-y-6 xl:col-span-7 2xl:col-span-7">
                <section class="rounded-2xl border border-outline-variant/20 bg-white p-5 shadow-sm sm:p-8">
                    <div class="mb-7 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        <h2 class="flex items-center gap-3 text-lg font-bold text-on-surface sm:text-xl">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                        ...
                        <label class="space-y-2 sm:col-span-2">
                            <span class="block text-sm font-semibold text-on-surface">Tên lớp <span class="text-error">*</span></span>
                        ...
                        {{-- Mã môn học --}}
                        <label class="space-y-2 sm:col-span-2">
                            <span class="block text-sm font-semibold text-on-surface">Mã môn học</span>
                            <input
                        ...
                        {{-- Mô tả --}}
                        <label class="space-y-2 sm:col-span-2">
                            <span class="block text-sm font-semibold text-on-surface">Mô tả</span>
                    ...
                    <div class="mt-7 space-y-4">
                        ...
                        <div class="rounded-2xl border border-outline-variant/20 bg-surface-container-low p-5">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    <label class="block text-[13px] font-semibold text-on-surface mb-1.5">Vắng giữa giờ</label>
                                ...
                                <div>
                                    <label class="block text-[13px] font-semibold text-on-surface mb-1.5">Về sớm</label>
                                ...
                                <div>
                                    <label class="block text-[13px] font-semibold text-on-surface mb-1.5">Vắng</label>
                                ...
                                <div>
                                    <label class="block text-[13px] font-semibold text-on-surface mb-1.5">Có phép</label>
                        ...
                        <div class="rounded-2xl border border-outline-variant/20 bg-surface-container-low p-5">
                            <div class="flex flex-row items-center justify-between gap-5">
                                <div class="flex gap-3">
                                    ...
                                    <div>
                                        <span class="block text-[15px] font-bold text-on-surface">Yêu cầu duyệt tham gia</span>
                                        <p class="mt-1 max-w-2xl text-[13.5px] leading-relaxed text-on-surface-variant">Học viên tham gia bằng mã lớp cần được chủ lớp duyệt trước khi xuất hiện trong danh sách chính thức.</p>
                                    </div>
                                </div>
                ...
                <div class="sticky top-[140px] space-y-6">
                    <section class="overflow-hidden rounded-2xl border border-outline-variant/20 bg-white shadow-sm">
                        <div class="bg-primary p-6 text-white">
                            <div class="flex items-center justify-between gap-4">
                                <span class="rounded-full bg-white/15 px-3 py-1 text-[11px] font-bold uppercase tracking-wide">Xem trước</span>
                                <x-user.icon name="eye" :size="20" class="text-white/90" />
                            </div>
                            <h3 class="mt-4 text-xl font-bold leading-tight">{{ $previewName }}</h3>
                            <p class="mt-1.5 text-sm font-medium text-primary-fixed">{{ $previewSubject }}</p>
                            @if($generatedCode)
                    ...
                    <section class="rounded-2xl border border-outline-variant/20 bg-white p-6 shadow-sm">
                        <h3 class="flex items-center gap-2 text-[15px] font-bold text-on-surface">
                            <x-user.icon name="sparkles" :size="18" class="text-primary" />
                            Gợi ý nhập liệu
                        </h3>
