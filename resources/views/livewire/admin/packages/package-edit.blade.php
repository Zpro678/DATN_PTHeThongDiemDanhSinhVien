    ...
    <div class="w-full space-y-6">
        ...
        <div class="flex flex-col items-start justify-between gap-4 p-6 md:flex-row md:items-center lg:p-7 mb-2">
            <div>
                ...
                <h1 class="mt-1 text-[28px] font-black text-slate-900">Sửa gói dịch vụ</h1>
                <p class="text-sm text-slate-500">Cập nhật thông số và quyền lợi cho gói dịch vụ hiện tại.</p>
            </div>
