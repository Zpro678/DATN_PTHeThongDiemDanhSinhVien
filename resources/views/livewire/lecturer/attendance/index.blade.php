<div x-data="{
    ...
    cloneSessionName: '',
    cloneFormattedDate: ''
}" class="w-full px-6 pt-6 sm:px-10 lg:px-16 sm:pt-8 min-h-screen space-y-6 pb-24">
