            ...
            <div class="flex-1 min-w-0 space-y-6">
                ...
                <div class="rounded-2xl border border-outline-variant/20 bg-white shadow-sm overflow-hidden">
                    ...
                    <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <label class="col-span-1 md:col-span-2 block">
                            <span class="mb-2 block text-base font-bold text-on-surface">Mã môn học <span class="text-sm font-normal text-on-surface-variant">(Tùy chọn)</span></span>
                            <input type="text" wire:model="subjectCode" class="w-full rounded-xl border border-outline-variant/30 bg-surface-container-lowest px-4 py-3 text-base outline-none uppercase transition-all focus:border-primary focus:ring-2 focus:ring-primary/20" placeholder="VD: WEB301">
                            @error('subjectCode') <span class="text-error text-sm mt-1 block">{{ $message }}</span> @enderror
                        </label>
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div class="mt-5">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    <label class="block text-sm font-bold text-on-surface mb-1">Vắng giữa giờ</label>
                                    <input wire:model="attendanceRules.partial" type="number" step="0.5" class="w-full rounded-xl border border-outline-variant/30 px-3 py-2 text-base focus:border-primary focus:ring-1 focus:ring-primary">
                                </div>
                                <div>
                                    <label class="block text-sm font-bold text-on-surface mb-1">Về sớm</label>
                                    <input wire:model="attendanceRules.early_leave" type="number" step="0.5" class="w-full rounded-xl border border-outline-variant/30 px-3 py-2 text-base focus:border-primary focus:ring-1 focus:ring-primary">
                                </div>
                                <div>
