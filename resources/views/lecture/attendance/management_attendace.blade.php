    ...
    <div class="max-w-[1400px] mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            <div class="group bg-white rounded-2xl p-7 border border-slate-200 shadow-sm flex justify-between items-start gap-4 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg cursor-pointer">
                <div class="min-w-0 flex-1">
                    <p class="text-slate-500 text-[13px] font-bold mb-4 uppercase tracking-wider leading-snug transition-colors group-hover:text-blue-600">Tổng số lớp</p>
                    <p class="text-2xl font-extrabold text-slate-900 tracking-tight">12</p>
                </div>
                <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center text-white shadow-lg shadow-blue-500/25 flex-shrink-0 transition-all duration-300 group-hover:scale-110">
            ...
            <div class="group bg-white rounded-2xl p-7 border border-slate-200 shadow-sm flex justify-between items-start gap-4 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg cursor-pointer">
                <div class="min-w-0 flex-1">
                    <p class="text-slate-500 text-[13px] font-bold mb-4 uppercase tracking-wider leading-snug transition-colors group-hover:text-indigo-600">Phiên đang diễn ra</p>
                    <p class="text-2xl font-extrabold text-slate-900 tracking-tight">01</p>
                </div>
                <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500 to-indigo-700 flex items-center justify-center text-white shadow-lg shadow-indigo-500/25 flex-shrink-0 transition-all duration-300 group-hover:scale-110">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
            ...
            <div class="group bg-white rounded-2xl p-7 border border-slate-200 shadow-sm flex justify-between items-start gap-4 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg cursor-pointer">
                <div class="min-w-0 flex-1">
                    <p class="text-slate-500 text-[13px] font-bold mb-4 uppercase tracking-wider leading-snug transition-colors group-hover:text-emerald-600">Điểm danh hôm nay</p>
                    <p class="text-2xl font-extrabold text-slate-900 tracking-tight">92%</p>
                </div>
                <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-500 to-emerald-700 flex items-center justify-center text-white shadow-lg shadow-emerald-500/25 flex-shrink-0 transition-all duration-300 group-hover:scale-110">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
            ...
            <div class="group bg-white rounded-2xl p-7 border border-slate-200 shadow-sm flex justify-between items-start gap-4 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg cursor-pointer">
                <div class="min-w-0 flex-1">
                    <p class="text-slate-500 text-[13px] font-bold mb-4 uppercase tracking-wider leading-snug transition-colors group-hover:text-violet-600">SV đã điểm danh</p>
                    <p class="text-2xl font-extrabold text-slate-900 tracking-tight">348</p>
                </div>
                <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-violet-500 to-violet-700 flex items-center justify-center text-white shadow-lg shadow-violet-500/25 flex-shrink-0 transition-all duration-300 group-hover:scale-110">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
                ...
                {{-- Điểm danh thủ công --}}
                <button class="group relative flex flex-col sm:flex-row items-start gap-4 sm:gap-6 text-left p-5 sm:p-7 bg-white border-2 border-slate-200 rounded-2xl shadow-sm hover:border-amber-400 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-amber-500/20 overflow-hidden">
                    ...
                    <div class="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-br from-amber-400 to-orange-500 flex items-center justify-center text-white shadow-lg shadow-amber-400/30 flex-shrink-0 group-hover:scale-110 transition-transform duration-300 relative z-10">
                        <svg class="w-7 h-7 sm:w-8 sm:h-8" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <div class="flex-1 relative z-10 w-full">
                        <div class="flex justify-between items-start w-full">
                            ...
                            <svg class="hidden sm:block w-5 h-5 text-slate-300 flex-shrink-0 mt-1 group-hover:text-amber-500 group-hover:translate-x-1 transition-all duration-300" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                ...
                <button class="group relative flex flex-col sm:flex-row items-start gap-4 sm:gap-6 text-left p-5 sm:p-7 bg-white border-2 border-blue-200 rounded-2xl shadow-sm hover:border-blue-400 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-blue-500/20 overflow-hidden">
                    ...
                    <div class="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white shadow-lg shadow-blue-500/30 flex-shrink-0 group-hover:scale-110 transition-transform duration-300 relative z-10">
                        <svg class="w-7 h-7 sm:w-8 sm:h-8" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <div class="flex-1 relative z-10 w-full">
                        <div class="flex justify-between items-start w-full">
                            <div class="flex flex-col sm:flex-row sm:items-center gap-1.5 sm:gap-2.5 mb-1.5 w-full">
                                <h3 class="text-lg font-bold text-slate-900 group-hover:text-blue-700 transition-colors">Link / QR + GPS</h3>
                                <span class="self-start sm:self-center inline-flex items-center gap-1 bg-gradient-to-r from-blue-500 to-blue-600 text-white text-[10px] font-bold px-2.5 py-0.5 rounded-full uppercase tracking-wider shadow-sm">
                            ...
                            <svg class="hidden sm:block w-5 h-5 text-slate-300 flex-shrink-0 mt-1 group-hover:text-blue-500 group-hover:translate-x-1 transition-all duration-300" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                            </svg>
                        </div>
