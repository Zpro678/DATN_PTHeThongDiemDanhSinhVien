<x-app-layout page-title="Bảng Phân Tích">
    <div class="font-sans">
        <div class="max-w-[1400px] mx-auto sm:px-6 lg:px-2">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                {{-- Card 1 --}}
                <div class="bg-white rounded-2xl p-5 border border-slate-200 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group flex justify-between items-center">
                    <div class="flex-1 min-w-0 mr-4">
                        <p class="text-blue-600 text-[13px] font-extrabold uppercase tracking-wider mb-2 leading-snug">Tỷ Lệ Có Mặt TB</p>
                        <p class="text-[18px] font-extrabold text-slate-900 tracking-tight truncate pb-1">94.2%</p>
                    </div>
                    <div class="w-[52px] h-[52px] rounded-2xl bg-[#2563eb] shadow-lg shadow-blue-500/40 flex items-center justify-center text-white shrink-0 group-hover:scale-105 transition-transform duration-300">
                ...
                <div class="bg-white rounded-2xl p-5 border border-slate-200 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group flex justify-between items-center">
                    <div class="flex-1 min-w-0 mr-4">
                        <p class="text-red-500 text-[13px] font-extrabold uppercase tracking-wider mb-2 leading-snug">SV Có Nguy Cơ</p>
                        <p class="text-[18px] font-extrabold text-slate-900 tracking-tight truncate pb-1">142</p>
                    </div>
                    <div class="w-[52px] h-[52px] rounded-2xl bg-red-500 shadow-lg shadow-red-500/40 flex items-center justify-center text-white shrink-0 group-hover:scale-105 transition-transform duration-300">
                        <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                ...
                <div class="bg-white rounded-2xl p-5 border border-slate-200 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group flex justify-between items-center">
                    <div class="flex-1 min-w-0 mr-4">
                        <p class="text-orange-500 text-[13px] font-extrabold uppercase tracking-wider mb-2 leading-snug">Lớp Tiến Bộ Nhất</p>
                        <p class="text-[18px] font-extrabold text-slate-900 tracking-tight truncate pb-1">Vật Lý 101</p>
                    </div>
                    <div class="w-[52px] h-[52px] rounded-2xl bg-orange-500 shadow-lg shadow-orange-500/40 flex items-center justify-center text-white shrink-0 group-hover:scale-105 transition-transform duration-300">
                        <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden flex flex-col mb-8 hover:shadow-md transition-shadow duration-300">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse whitespace-nowrap">
                        <thead>
                            <tr class="bg-white text-[14px] font-bold text-slate-800 uppercase tracking-wider border-b border-slate-200">
