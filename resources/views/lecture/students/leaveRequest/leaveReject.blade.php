<x-app-layout variant="lecturer" page-title="Đơn xin nghỉ - Đã từ chối">
    <div class="max-w-[1400px] mx-auto font-sans">
        ...
        <div class="flex justify-center mb-8">
            <div class="flex w-full max-w-[480px] border-b-[2px] border-slate-200/70">
                <a href="/lecturer/students/leave" class="relative flex-1 flex justify-center items-center gap-1.5 pb-2.5 pt-2 px-1 md:px-2 text-slate-500 hover:text-slate-800 text-[14px] font-bold uppercase tracking-wide whitespace-nowrap transition-all duration-300 group hover:bg-slate-50/80 rounded-t-xl">
                ...
                <a href="/lecturer/students/leave/reject" class="relative flex-1 flex justify-center items-center gap-1.5 pb-2.5 pt-2 px-1 md:px-2 text-blue-600 text-[14px] font-bold uppercase tracking-wide whitespace-nowrap transition-all duration-300 group hover:bg-blue-50/40 rounded-t-xl">
                        ...
                        <table class="w-full min-w-[1000px] text-left border-collapse">
                            <thead>
                                <tr class="border-b border-slate-200 text-[14px] font-bold text-slate-800 uppercase tracking-wider bg-white whitespace-nowrap">
                                    ...
                                    <th class="px-6 py-5 text-center">Lý do từ chối</th>
                                ...
                                <tr class="hover:bg-slate-50/80 transition-colors group">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                <p class="font-bold text-slate-900 text-sm line-clamp-2">Elena Rodriguez</p>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <div class="inline-flex flex-col text-slate-800">
                                            <span class="font-bold">12/06/2026</span>
                                            <span class="text-[12px] text-slate-500">Ca 1 (07:00 - 09:30)</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 text-slate-600"><div class="line-clamp-2 min-w-[150px]">Xin nghỉ đi tiệc sinh nhật bạn.</div></td>
                                    <td class="px-6 py-4 text-slate-600 font-medium"><div class="line-clamp-2 min-w-[150px]">Lý do không chính đáng, vui lòng đi học đầy đủ.</div></td>
                                    <td class="px-6 py-4 text-center">
                                        <span class="inline-flex items-center px-3 py-1 rounded-full text-[11px] font-bold bg-[#fef2f2] text-red-700 border border-red-200">
                                            Đã từ chối
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 text-center">
                                        <button class="text-slate-400 hover:text-slate-600 p-1.5 rounded-md hover:bg-slate-100 transition-colors" title="Xem chi tiết">
