    ...
    <div class="w-full font-sans">
        ...
        <div class="mb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <div class="flex flex-wrap items-center gap-2 shrink-0">
                <button class="inline-flex items-center gap-1.5 px-4 py-2 bg-emerald-600 text-white text-[12px] font-bold rounded-xl hover:bg-emerald-700 transition-all shadow-sm shadow-emerald-500/20 active:scale-[0.98] whitespace-nowrap">
                ...
                <button class="inline-flex items-center gap-1.5 px-4 py-2 bg-white text-red-600 text-[12px] font-bold rounded-xl border border-red-200 hover:bg-red-50 transition-all active:scale-[0.98] whitespace-nowrap">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="min-w-0 flex-1">
                            ...
                            <div class="flex flex-wrap items-center gap-x-3 gap-y-1 mt-1">
                                <span class="inline-flex items-center gap-1 text-[11px] font-bold text-blue-600 whitespace-nowrap">
                                    <svg class="w-3 h-3 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a2 2 0 100-4 2 2 0 000 4zm0 0c1.306 0 2.417.835 2.83 2M9 14a3.001 3.001 0 00-2.83 2M15 11h3m-3 4h2" /></svg>
                                    SV20210001
                                </span>
                                <span class="inline-flex items-center gap-1 text-[11px] font-medium text-slate-500 whitespace-nowrap">
            ...
            <div class="bg-white border border-slate-200/80 rounded-2xl shadow-sm overflow-hidden min-w-0">
                ...
                <div class="p-5">
                    ...
                    <div class="space-y-4" x-data="{ lightboxOpen: false, activeImage: '', activeTitle: '' }">
                        ...
                        <div class="space-y-2">
                            {{-- File 1 --}}
                            <div class="flex items-center gap-3 px-3.5 py-2.5 bg-slate-50 rounded-xl border border-slate-100 hover:border-blue-200 transition-colors group">
            ...
            <div class="bg-white border border-slate-200/80 rounded-2xl shadow-sm overflow-hidden min-w-0 flex flex-col h-full">
                ...
                <div class="p-5 space-y-2 flex-1 overflow-y-auto max-h-[300px] min-h-[150px]">
                    <div class="flex items-center justify-between py-2 px-3 rounded-lg bg-green-50/60 border border-green-100/60">
                        ...
                        <span class="text-[10px] font-bold text-emerald-700 bg-emerald-100 px-2 py-0.5 rounded-full whitespace-nowrap shrink-0">Có mặt</span>
                    </div>
                    <div class="flex items-center justify-between py-2 px-3 rounded-lg bg-green-50/60 border border-green-100/60">
                        <div class="min-w-0">
                    ...
                    <div class="flex items-center justify-between py-2 px-3 rounded-lg bg-amber-50/60 border border-amber-100/60">
                        ...
                        <span class="text-[10px] font-bold text-amber-700 bg-amber-100 px-2 py-0.5 rounded-full whitespace-nowrap shrink-0">Đi muộn</span>
                    </div>
                    <div class="flex items-center justify-between py-2 px-3 rounded-lg bg-green-50/60 border border-green-100/60">
                        <div class="min-w-0">
                    ...
                    <div class="flex items-center justify-between py-2 px-3 rounded-lg bg-red-50/60 border border-red-100/60">
                        ...
                        <span class="text-[10px] font-bold text-red-700 bg-red-100 px-2 py-0.5 rounded-full whitespace-nowrap shrink-0">Vắng</span>
                    </div>
