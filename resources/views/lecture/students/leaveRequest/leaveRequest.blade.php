    ...
    <div class="max-w-[1400px] mx-auto font-sans">
        ...
        <div class="flex justify-center mb-8">
            <div class="flex w-full max-w-[480px] border-b-[2px] border-slate-200/70">
                <a href="/lecturer/students/leave" class="relative flex-1 flex justify-center items-center gap-1.5 pb-2.5 pt-2 px-1 md:px-2 text-blue-600 text-[14px] font-bold uppercase tracking-wide whitespace-nowrap transition-all duration-300 group hover:bg-blue-50/40 rounded-t-xl">
                ...
                <a href="/lecturer/students/leave/approve" class="relative flex-1 flex justify-center items-center gap-1.5 pb-2.5 pt-2 px-1 md:px-2 text-slate-500 hover:text-slate-800 text-[14px] font-bold uppercase tracking-wide whitespace-nowrap transition-all duration-300 group hover:bg-slate-50/80 rounded-t-xl">
                ...
                <a href="/lecturer/students/leave/reject" class="relative flex-1 flex justify-center items-center gap-1.5 pb-2.5 pt-2 px-1 md:px-2 text-slate-500 hover:text-slate-800 text-[14px] font-bold uppercase tracking-wide whitespace-nowrap transition-all duration-300 group hover:bg-slate-50/80 rounded-t-xl">
                    <span class="absolute bottom-[-2px] left-0 w-full h-[2.5px] bg-slate-300 scale-x-0 group-hover:scale-x-100 transition-transform duration-300 rounded-t-md"></span>
                                ...
                                <tr class="hover:bg-blue-50/40 transition-colors group cursor-pointer" onclick="window.location='/lecturer/students/leave/1'">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                <p class="font-bold text-slate-900 text-sm line-clamp-2">Alex Thompson</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 text-slate-600 font-medium text-sm"><div class="line-clamp-2">CS402: Thuật toán</div></td>
                                    <td class="px-6 py-4 text-center">
                                        <div class="inline-flex flex-col text-slate-800">
                                            <span class="font-bold">18/06/2026</span>
                                            <span class="text-[12px] text-slate-500">Ca 1 (07:00 - 09:30)</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 text-slate-600"><div class="line-clamp-2 min-w-[150px]">Bị ốm, sốt cao không thể đi học được.</div></td>
                                    <td class="px-6 py-4 text-center">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-bold bg-[#fff7ed] text-orange-700 border border-orange-200/60">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <div class="flex items-center justify-center gap-2" onclick="event.stopPropagation()">
                                            <button class="p-1.5 text-green-600 bg-green-50 hover:bg-green-100 rounded-md transition-colors" title="Duyệt">
                                            ...
                                            <button class="p-1.5 text-red-600 bg-red-50 hover:bg-red-100 rounded-md transition-colors" title="Từ chối">
                                ...
                                <tr class="hover:bg-blue-50/40 transition-colors group cursor-pointer" onclick="window.location='/lecturer/students/leave/2'">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                <p class="font-bold text-slate-900 text-sm line-clamp-2">Marcus Chen</p>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <div class="inline-flex flex-col text-slate-800">
                                            <span class="font-bold">19/06/2026</span>
                                            <span class="text-[12px] text-slate-500">Ca 3 (13:00 - 15:30)</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 text-slate-600"><div class="line-clamp-2 min-w-[150px]">Gia đình có việc đột xuất ở quê.</div></td>
                                    <td class="px-6 py-4 text-center">
                                        <span class="text-[13px] font-medium text-slate-500">Không có</span>
                                    </td>
                                    <td class="px-6 py-4 text-center">
                                        <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-bold bg-[#fff7ed] text-orange-700 border border-orange-200/60">
                                            <span class="w-1.5 h-1.5 rounded-full bg-orange-500 animate-pulse"></span>
