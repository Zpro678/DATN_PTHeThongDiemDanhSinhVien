<x-app-layout variant="lecturer" page-title="Sinh viên - Cảnh báo">
    <div class="max-w-[1400px] mx-auto font-sans">
        ...
        <div class="flex justify-center mb-8">
            <div class="flex w-full max-w-[480px] border-b-[2px] border-slate-200/70">
                ...
                <a href="/lecturer/students/warning" class="relative flex-1 flex justify-center items-center gap-1.5 pb-2.5 pt-2 px-1 md:px-2 text-blue-600 text-[14px] font-bold uppercase tracking-wide whitespace-nowrap transition-all duration-300 group hover:bg-blue-50/40 rounded-t-xl">
