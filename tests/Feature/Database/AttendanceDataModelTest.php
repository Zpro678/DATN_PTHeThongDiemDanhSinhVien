...
class AttendanceDataModelTest extends TestCase
{
    ...
    public function test_seeded_attendance_data_has_consistent_relationships(): void
    {
        ...
        $this->assertCount(10, $courseClass->members);
        $this->assertCount(10, $courseClass->users);
        $this->assertCount(5, $courseClass->sessions);
        $this->assertCount(10, $courseClass->attendanceSummaries);
        $this->assertTrue($student->joinedClasses->contains($courseClass));
        $this->assertSame($teacher->id, $courseClass->owner->id);
        $this->assertSame(10, $courseClass->sessions->first()->attendanceRecords()->count());
        $this->assertDatabaseCount('attendance_records', 50);
        $this->assertDatabaseCount('attendance_summaries', 10);
        ...
        $this->assertCount(9, $courseClass->users()->get());
    }
    ...
    public function test_seeded_billing_notifications_and_audit_data_are_accessible(): void
    {
        ...
        $this->assertSame(50, AttendanceRecord::query()->count());
    }
}
